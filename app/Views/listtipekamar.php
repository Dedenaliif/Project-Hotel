                ...
                <!-- Basic Layout -->
                 <div class="card">
                    <div class="card-header">
                        <div class="card-title"><?php echo $title ?> 
                    </div>
                    <a href="<?php echo base_url('tipekamar/create') ?>" class="btn btn-success btn-sm mt-3"><i class="fa fa-plus m-2"></i>Create</a>
                    </div>
                    <div class="card-body">
                    <table id="tipekamar" class="uk-table uk-table-hover uk-table-striped" style="width: 100%;">
							<thead>
								<tr>
                                    <th>Kode Kamar</th>
									<th>Tipe Kamar</th>
