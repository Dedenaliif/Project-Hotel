              ...
              <div class="row">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="<?php echo base_url('kamar/create') ?>" class="btn btn-success btn-sm mt-3"><i class="fa fa-plus m-2"></i>Create</a>
                    </div>
                    <div class="card-body">
                    <table id="kamar" class="uk-table uk-table-hover uk-table-striped" style="width: 100%;">
							<thead>
								<tr>
                                    <th>No Kamar</th>
									<th>Tipe Kamar</th>
...
var site_url = "<?php echo base_url('kamar'); ?>";
